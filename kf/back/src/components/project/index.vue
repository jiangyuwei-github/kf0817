<template>
    <div>
        ...
        <div class="console-bar">
            <head-bar :toptitle="'banner管理'"></head-bar>
            <left-bar :active="'banner'"></left-bar>
        </div>
        <div class="content">
            <div class="allTitle">banner管理</div>
            <Row>
                <Col span="20">
            ...
            <Modal v-model="modelFlag" :mask-closable = "false" title="设置" width=800 :footer-hide="true" class-name="vertical-center-modal" >
                <Form ref="banner" :model="currentData" :rules="ruleValidate" :label-width="70">
                    <FormItem label="图片" class="private-console-tips" prop="img">
